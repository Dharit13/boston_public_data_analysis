...
Eight briefings built from City of Boston open data: **employee earnings** (2015–2025), **fire incidents** (2012–2024), **police incidents** (2016–2025), **311 service requests** (2016–2026 YTD), **Vision Zero** crashes and fatalities (2015–2026 YTD), **approved building permits** (+ ZBA, 2006–2026 YTD), **food establishment inspections** (+ active licenses, 2006–2026 YTD), and **Public Works** Code Enforcement tickets (+ work-zone and asset snapshots, 2008–2026 YTD).
...
| Public Works Code Enforcement tickets, 2008–2026 YTD | [Open](https://dharit13.github.io/boston_public_data_analysis/public-works/) | [boston-public-works-summary.md](public-works/boston-public-works-summary.md) | [public-works/](public-works/) |
...
- **Food safety (2025):** 12,414 inspections (+22.7% vs 2019) · fail share **40.3%**. HE_Pass is **49.9%**, not a majority. Always-pass and be-cautious share the year window (**2019, 2024, 2025, 2026 YTD**); Hospital / School / Cultural / Hotel kitchens are not ranking lists. Ice cream / Pharmacy / Grocery overlays use sourced lists (J.P. Licks, CVS, Trader Joe’s). **Do not add 3,347 licenses.** **2026 is not a full year.**
- **Public Works (2025):** 63,226 Code Enforcement tickets (+36.8% vs 2019) · **80%** trash storage. Open caseload is **116,431** (snapshot). Work zones **810** permits as of 1 Sep 2026; streetlights are a **2016** inventory. **Do not add 311.** **2026 is not a full year.**
...
boston_public_data_analysis/
  ...
  docs/                              GitHub Pages site (HTML + charts)
    earnings/  fire/  crime/  311/  vision-zero/  building-permits/  food-safety/  public-works/
  employee-earnings/
    README.md
  ...
  food-safety/
    ...
    analyze_food.py
    ice_cream_web_matches.json
    outputs/*.json
    canvases/
  public-works/
    README.md
    boston-public-works-summary.md
    analyze_public_works.py
    outputs/*.json
    canvases/
```
...
cd ../public-works && python3 analyze_public_works.py
```
